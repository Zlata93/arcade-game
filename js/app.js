...
class Enemy {
    ...
    //handle collision
    collision() {
        if (player.x < this.x + 75 && player.x + 75 > this.x && player.y < this.y + 25 && player.y + 25 > this.y) {
...
class Gem {
    constructor(y, spriteNumber) {
        this.spriteArr = ['images/Gem Blue1.png', 'images/Gem Orange1.png', 'images/Gem Green1.png'];
    ...
    collect() {
        ...
        if (player.x < this.x + 55 && player.x + 55 > this.x && player.y < this.y + 25 && player.y + 55 > this.y) {
